...
2. Go to your repository at [iFlameing/my-site](https://github.com/iFlameing/my-site).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `my-site.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | my-site.example.com | The hostname or IP address of your Docker Swarm manager. |
...
- [Backend Tests Workflow](https://github.com/iFlameing/my-site/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/iFlameing/my-site/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/iFlameing/my-site-backend`) and Frontend (`ghcr.io/iFlameing/my-site-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of my-site.example.com](https://github.com/iFlameing/my-site/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/my-site.example.com.yml` stack.
