...
```
DEPLOY_ENV=prod
DEPLOY_HOST=my-site.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
Deploy the stack defined in `devops/stacks/my-site.example.com.yml` to the remote server with:
